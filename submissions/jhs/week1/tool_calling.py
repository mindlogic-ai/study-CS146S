...
Description: Lists all top-level functions and their return types from a Python file.
Arguments: file_path (optional) - path to the Python file to analyze

When asked to call a tool, respond with ONLY a JSON object in this format:
