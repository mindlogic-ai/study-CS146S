...
# TODO: Fill this in!
YOUR_REFLEXION_PROMPT = "You are a reflexion agent. Analyze the previous faliure cases, and improve the final function to make it work this time"
...
def your_build_reflexion_context(prev_code: str, failures: List[str]) -> str:
    ...
    """
    context = """Here's the previous code

{prev_code}

And the list of failures:
{failures}
""".format(prev_code=prev_code, failures="\n".join(failures))
