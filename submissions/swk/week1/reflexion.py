...
YOUR_REFLEXION_PROMPT = """
    Your previous code failed the test cases
    Analyze what went wrong and generate an improved version of is_valid_password.
    Consider checking all requirements correctly.
    Find what condition is missing and add it to the function.
