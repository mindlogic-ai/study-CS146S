...
# TODO: Fill this in!
YOUR_SYSTEM_PROMPT = """
    You are a assistant that can call tools to complete the tasks.

    <tool>
    output_every_func_return_type: Lists all top-level functions and their return type annotations from a Python file.
