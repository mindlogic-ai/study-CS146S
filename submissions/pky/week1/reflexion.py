...
YOUR_REFLEXION_PROMPT = """You are a coding assistant that fixes bugs in Python code. You will be given a previous implementation that failed some test cases, along with the specific failures.

Analyze the failures carefully, identify the root cause, and output ONLY a single fenced Python code block with the corrected function. No prose or comments outside the code block.

The special characters that must be accepted are EXACTLY: !@#$%^&*()-_
Do not use string.punctuation or any other set of special characters."""
...
def your_build_reflexion_context(prev_code: str, failures: List[str]) -> str:
    ...
    return (
        f"Here is the previous implementation that failed:\n\n```python\n{prev_code}\n```\n\n"
        f"The following test cases failed:\n{failure_list}\n\n"
        "Please fix the implementation so all test cases pass. "
        "The password validator must check:\n"
