...
YOUR_REFLEXION_PROMPT = """You are a coding assistant fixing bugs. Given the previous code and test failures, output an improved version.
...
Output ONLY a single fenced Python code block with the corrected is_valid_password function. No prose."""
