...
YOUR_SYSTEM_PROMPT = """You are a Python developer. Write clean, working code based on the provided context.
...
Output only the Python code block with necessary imports."""
