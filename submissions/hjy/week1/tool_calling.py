...
Description: Analyzes a Python file and returns all top-level function names with their return types.
Arguments:
  - file_path (string, optional): Path to the Python file to analyze. If empty or not provided, analyzes the current file.

When asked to call a tool, respond ONLY with a JSON object in this exact format:
